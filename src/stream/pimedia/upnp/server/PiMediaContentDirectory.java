 ...
 * 
 */
public class PiMediaContentDirectory extends AbstractContentDirectoryService {

	private Map<String, DIDLObject> content = new HashMap<String, DIDLObject>();
	private Context context;
	private SharedPreferences preferences;

	public PiMediaContentDirectory(Context context) {
		...
		if (mediaCursor != null) {
			...
			while (!mediaCursor.isAfterLast()) {
				...
				String uri = "http://" + getIpAddress() + ":"
						+ PiMediaUpnpServerService.PORT + "/?id=" + id + "&f='"
						+ name + "'";
